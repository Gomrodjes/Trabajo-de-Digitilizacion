...
public class ImportarLibros {
    public static void main(String[] args) {
        ...
        String uri = "mongodb+srv://gomezrojes22:j1234@cluster0.a1la7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"; // Si usas MongoDB Atlas, cambia la URI
        try (MongoClient mongoClient = MongoClients.create(uri)) {
            MongoDatabase database = mongoClient.getDatabase("ProyectoBDD");
